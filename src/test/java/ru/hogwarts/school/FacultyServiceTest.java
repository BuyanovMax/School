...
public class FacultyServiceTest {
    ...
    public void createFacultyTest() {
        Mockito.when(facultyRepository.save(new Faculty( "Name", "Color"))).thenReturn(new FacultyReadDto("Name"));
        FacultyReadDto expected = new FacultyReadDto("Name");
//        Faculty expected = new Faculty(1L, "Name", "Color");

        FacultyReadDto actual = facultyService.createFaculty(new FacultyCreateDto( "Name", "Color"));
...
//        Faculty expected = new Faculty(1L, "Name", "Color");
//
//        Faculty actual = facultyService.updateFaculty(new Faculty(1L, "Name", "Color"));
//
//        assertEquals(expected, actual);
//
//    }
